...
function showProductInfo() {
    ...
    document.getElementById("prod-name-to-show").textContent = specificProduct.currency + " " + specificProduct.name
    document.getElementById("prod-cost-to-show").textContent = specificProduct.cost
